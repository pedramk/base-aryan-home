...
Route::get("/ghabz", function () {
    Http::post("https://core.inquiry.ayantech.ir/webservices/core.svc/ElectricityBillInquiry", [
...
})->middleware(['auth'])->name('dashboard'); // + verified middleware
